...
public class FizzBuzz {
    public static void main(String[] args) {
        ...
        if (result) {
            //                             "" + 'A' ==> "A"
            boolean b1 = word1.endsWith( ""+word2.charAt(0) ); //word1 ends with first character of word
            boolean b2 = word2.startsWith( ""+word1.charAt(word1.length()-1)); //word2 starts with last character of word
